...
object ModLootTableProvider {
    ...
    fun registerBlocks(@Suppress("UNUSED_PARAMETER") consumer: BiConsumer<ResourceKey<LootTable>, LootTable.Builder>) {
        ...
        lootTable.computedDrop(ModBlocks.LAMP)
        lootTable.computedDrop(ModBlocks.SWITCH)
        lootTable.computedDrop(ModBlocks.LED_PANEL)
        lootTable.computedDrop(ModBlocks.SMOOTH_LED_PANEL)
        lootTable.validate()
    }
}
